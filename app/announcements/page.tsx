  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="px-4 pt-8 pb-10 space-y-4">
        {/* Welcome card */}
        <div
          className="rounded-3xl bg-white shadow-sm p-5"
          style={{ borderLeft: "4px solid #6B8FD4" }}
        >
          <p className="text-sm text-charcoal/80 leading-relaxed">
            Ça y est, le compte à rebours est lancé ! Retrouvez ici tout ce
            qu&apos;il faut pour préparer le grand jour : programme, adresses,
            photos etc ! Rendez-vous le jour J avec toute votre bonne humeur !
          </p>
          <p className="mt-3 text-sm font-bold" style={{ color: "#C4607A" }}>
            Manu &amp; Flore 💍
          </p>
        </div>
